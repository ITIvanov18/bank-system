...
/**
 * DTO за директно отпускане на заем от служител.
 * Валидациите гарантират, че всички задължителни полета са налични и имат допустими стойности преди service/business проверките.
 */
